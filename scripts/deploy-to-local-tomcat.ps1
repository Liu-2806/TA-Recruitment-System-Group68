...
$sourceJavaRoot = Join-Path $projectRoot "src\com\bupt\ta"
$buildRoot = Join-Path $projectRoot "build\tomcat-staging"
$stagingApp = Join-Path $buildRoot $AppName
$stagingClasses = Join-Path $stagingApp "WEB-INF\classes"
