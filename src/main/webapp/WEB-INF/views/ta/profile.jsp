...
<body>
  <div class="ta-profile-shell">
    <header class="ta-profile-header">
      <div class="ta-profile-header__inner">
        <a class="app-brand" href="<%= contextPath %>/ta-profile-preview.jsp">
          <span class="app-brand__mark">T</span>
          <span class="app-brand__text">My Profile</span>
        </a>

        <a class="ta-profile-header__back" href="<%= contextPath %>/ta-dashboard-preview.jsp">
          <span class="ta-profile-header__back-icon" aria-hidden="true">
