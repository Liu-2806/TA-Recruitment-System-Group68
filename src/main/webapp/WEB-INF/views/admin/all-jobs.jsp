  ...
  <div class="admin-alljobs-shell">
    ...
    <div class="admin-alljobs-main">
      <header class="admin-topbar">
        <div class="admin-topbar__eyebrow">Recruitment Management</div>
      ...
      <main class="admin-alljobs-content">
        <div class="admin-alljobs-heading">
          <a class="admin-alljobs-heading__back" href="<%= contextPath %>/admin-dashboard-preview.jsp">
            <span class="admin-alljobs-heading__back-icon" aria-hidden="true">
              <svg viewBox="0 0 24 24" focusable="false">
